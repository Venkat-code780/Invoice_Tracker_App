...
export default class InvoiceWebPart extends BaseClientSideWebPart<IInvoiceWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IInvoiceProps> = React.createElement(
      Invoice,
      {
